...
class TestNearestInterpOp(OpTest):
    ...
    def setUp(self):
        ...
        # print("output_h={}, output_w={}, scale_h={}, scale_w={}".format(output_h, output_w, scale_h, scale_w))
    ...
    def test_check_grad(self):
        ...
        self.check_grad_with_place(self.place, ['X'], 'Out', in_place=True, max_relative_error=0.006)
