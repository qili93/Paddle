...
class _BatchNormBase(Layer):
    ...
    def __init__(
        ...
        with paddle.fluid.dygraph.no_grad():
            weight_trans = tensor.npu_identity(self.weight, 3) # ACL_FORMAT_NC1HWC0 = 3
            bias_trans = tensor.npu_identity(self.bias, 3) # ACL_FORMAT_NC1HWC0 = 3
            mean_trans = tensor.npu_identity(self._mean, 3) # ACL_FORMAT_NC1HWC0 = 3
            var_trans = tensor.npu_identity(self._variance, 3) # ACL_FORMAT_NC1HWC0 = 3
