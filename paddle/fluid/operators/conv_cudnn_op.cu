 ...
 public:
  void Compute(const framework::ExecutionContext& ctx) const override {
    ...
    const bool compute_in_nhwc =
        dtype == GPUDNN_DATA_HALF && IsVoltaOrLater(dev_ctx);
    ...
    using search = SearchAlgorithm<gpuDnnConvolutionFwdAlgoPerf_t>;
    ...
    if (ctx.Attr<int>("groups") > 1) {
      algo = static_cast<gpuDnnConvolutionFwdAlgo_t>(0);
    }
#endif
...
class CUDNNConvGradOpKernel : public framework::OpKernel<T> {
 public:
  void Compute(const framework::ExecutionContext& ctx) const override {
    ...
    gpuDnnConvolutionBwdDataAlgo_t data_algo =
        static_cast<gpuDnnConvolutionBwdDataAlgo_t>(0);
    gpuDnnConvolutionBwdFilterAlgo_t filter_algo =
        static_cast<gpuDnnConvolutionBwdFilterAlgo_t>(0);
    ...
    if (input_grad) {
      ...
      using search1 = SearchAlgorithm<gpuDnnConvolutionBwdDataAlgoPerf_t>;
      data_algo =
    ...
    if (filter_grad) {
      ...
      using search2 = SearchAlgorithm<gpuDnnConvolutionBwdFilterAlgoPerf_t>;
      filter_algo =
...
class CUDNNConvDoubleGradOpKernel : public framework::OpKernel<T> {
 public:
  void Compute(const framework::ExecutionContext& ctx) const override {
    ...
    gpuDnnConvolutionFwdAlgo_t fwd_algo1 =
        static_cast<gpuDnnConvolutionFwdAlgo_t>(0);
    gpuDnnConvolutionFwdAlgo_t fwd_algo2 =
        static_cast<gpuDnnConvolutionFwdAlgo_t>(0);
    gpuDnnConvolutionBwdDataAlgo_t data_algo =
        static_cast<gpuDnnConvolutionBwdDataAlgo_t>(0);
    gpuDnnConvolutionBwdFilterAlgo_t filter_algo =
    ...
    if (ddO) {
      ...
      if (ddX) {
        ...
        using search1 = SearchAlgorithm<gpuDnnConvolutionFwdAlgoPerf_t>;
      ...
      if (ddW) {
        ...
        using search2 = SearchAlgorithm<gpuDnnConvolutionFwdAlgoPerf_t>;
    ...
    if (dW && ddX) {
      ...
      using search3 = SearchAlgorithm<gpuDnnConvolutionBwdFilterAlgoPerf_t>;
      filter_algo =
    ...
    if (ddW && dX) {
      ...
      using search4 = SearchAlgorithm<gpuDnnConvolutionBwdDataAlgoPerf_t>;
      data_algo =
