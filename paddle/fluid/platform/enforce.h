...
/***** HIPDNN ERROR *****/
inline bool is_error(hipdnnStatus_t stat) {
  return stat != HIPDNN_STATUS_SUCCESS;
}

inline std::string build_nvidia_error_msg(hipdnnStatus_t stat) {
  std::string msg(" Hipdnn error, ");
